  ...
  <div class="container-user-workingtime">
    <div class="card">
        <div class="clocks" id="container">
          ...
          <div style="width:100%">
            <table>
              ...
              <tr>
                ...
                <td><Clock @event-clocks="setStart($event)" :user="user" :clockIn="isActive" :startDate="workingTime.start" ref="clockManager" /></td>
              </tr>
            </table>
          </div>
          ...
          <div style="display: flex; align-items: center; width:100%">
            <button type="button" :class="{ active: isCollapsed }" @click="setCollapseState" :disabled="false">
...
export default {
  ...
  methods: {
    ...
    createWorkingTime() {
      return WorkingTimeService.create(this.$store.state.auth.user.token, this.user.id, {
