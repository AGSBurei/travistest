...
config :timemanager, TimemanagerWeb.Auth.Guardian,
  issuer: "timemanager",
  secret_key: "AVQfNkEFMudwSdBDcHYbaJ5ESBArkk7C36voHZxEM63FQALcI8xwzHrylvL/1jeP"
...
config :timemanager, TimemanagerWeb.Endpoint,
  ...
  live_view: [signing_salt: "t3ZbhPQW"]
